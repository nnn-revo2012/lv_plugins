...
namespace Plugin_Jewel {
    public class Plugin_Jewel : ISitePlugin {
        #region ■定義

        private class FormFlashJewel : FormFlash {
            public FormFlashJewel(Performer pef)
                : base(pef) {
            }
        }
        ...
        public string Caption    { get { return "Jewel用のプラグイン(2019/05/03版)"; } }

        public string TopPageUrl { get { return "https://www.j-live.tv/"; } }
        ...
        public List<Performer> Update() {
            ...
            foreach (JSObject jso in jso2) {
                ...
                p.ImageUrl    = jso.GetField("img", BindingFlags.Default).GetValue(null) as string;
        ...
        public FormFlash OpenFlash(Performer performer) {
            //フラッシュ窓を返す
            return new FormFlashJewel(performer);
        }
